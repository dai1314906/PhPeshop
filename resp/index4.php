...
<div id="container">
                ...
                <div class="span4">
                    <div id="myCarousel" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="active item"><img src="images/j1.png" alt=""  /></div>
                            <div class="item"><img src="images/j2.png" alt=""  /></div>
                            <div class="item"><img src="images/j3.png" alt=""  /></div>
    ...
    <div id="content">
        <div class="row">
            <?php
            include ("conn.php");
            $sql=mysqli_query($link,"select * from tb_commodity join tb_commodity_category on tb_commodity_category.category_name = tb_commodity.category_name where tb_commodity.category_name = '键盘'");
