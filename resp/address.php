...
<div id="container">
    ...
    <div id="container1">
        ...
        <div id="block">
            <br>
            <br>
            <h3 class="font">请填写地址信息</h3>
            <br>
            <form method="post" action="insertaddress.php">
                <div class="form-group">
                    <span class="glyphicon glyphicon-user"></span>&nbsp;
                    <input type="text" name="add_consigner" id="add_consigner" value="" placeholder="请填写收货人">
                </div>
                <div class="form-group">
                    <span class="glyphicon glyphicon-phone-alt"></span>
                    <input type="text" name="add_tel" id="add_tel" value="" placeholder="请填写收货人电话">
                </div>
                <div class="form-group">
                    <span class="glyphicon glyphicon-home"></span>
                    <input type="text" name="add_content" id="add_content" value="" placeholder="请填写详细地址">
                </div>
                <br>

                <div class="form-group">
                    <button type="submit" name="Submit" class="btn btn_lg fontcolor">添加</button>
                    <button type="reset" name="Reset" class="btn btn_lg fontcolor">重置</button>
                </div>
                <br>
                <br>
                <div>
                    <a href="display_address.php" style="color: #FF6100;"><h3>查看地址</h3></a>
                </div>
            </form>
        </div>
    </div>
