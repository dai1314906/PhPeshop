...
<div id="container">
    ...
    <div id="container1">
        <br>
        <p><a href='address.php' style='font-size: 20px;color: #FF6100'>没有地址?请添加！</a></p><br>
        <br>
        <br>
        <table width="1000" bgcolor="#f5f5f5" height=" " border="0" align="center" cellpadding="1" cellspacing="0" >
            <tr>
                <td height="30" align="center" style="font-size: 20px;color: #FF6100;">收货人</td>
                <td align="center" style="font-size: 20px;color: #FF6100;">联系电话</td>
                <td align="center" style="font-size: 20px;color: #FF6100;">详细地址</td>
                <td align="center" style="font-size: 20px;color: #FF6100;">操作</td>
            </tr>
            <?php
            include ("conn.php");
            $uid = $_SESSION['id'];
            ...
            if($row!= NULL){
                do{
                    ...
                    <tr>
                        ...
                        <td height="10" align="center" valign="top"><a href="delete_address.php?id=<?php echo $row->adid;?>"><span class="glyphicon glyphicon-trash"></span></a></td>
                    </tr>
                    <?php
                }while($row=mysqli_fetch_object($sql));
            }
            else{
                echo "<p><a href='address.php' style='font-size: 20px;color: #FF6100'>没有地址?请添加！</a></p><br>";
            }
            ?>
        </table>
    </div>
