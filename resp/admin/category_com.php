...
<div id="container">
    ...
    <div id="content2">
        ...
        <table width="800" bgcolor="white" height="40" border="0" align="center" cellpadding="1" cellspacing="0" >
            <td align="center" style="font-size: 20px; color: cornflowerblue; font-weight: bold;">添加商品分类！</td>
        </table>
        <br>
        <form method="post" action="save_category_com.php" onsubmit="return checkForm()" >
            <label style="color: cornflowerblue;">商品名称:&nbsp;&nbsp;&nbsp;&nbsp;</label>
            <input type="text" name="add_comname" id="add_comname" placeholder="请填写商品分类名称">
            <span id="admin_comname" class="error">*</span><br><br>
