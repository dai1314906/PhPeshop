...
<div id="container">
    ...
    <div id="content2">
    	...
    	链接名称:<input type="text" name="add_link_name" id="add_link_name" placeholder="请填写链接名称"><br>
    	链接url:<input type="text" name="add_link_url" id="add_link_url" placeholder="请添加链接url"><br>
