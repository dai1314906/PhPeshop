...
<div id="container">
    ...
    <div id="content2">
        ...
        <table width="800" bgcolor="white" height="40" border="0" align="center" cellpadding="1" cellspacing="0" >
            <td align="center" style="font-size: 20px; color: cornflowerblue; font-weight: bold;">添加支付方式！</td>
        </table>
        <br>
        <form action="save_payway.php" method="post">
            支付方式名称:<input type="text" name="add_payway" id="add_payway" placeholder="添加支付方式">
