...
<div id="content2">
    ...
    <table width="800" bgcolor="white" height="40" border="0" align="center" cellpadding="1" cellspacing="0" >
        <td align="center" style="font-size: 20px; color: cornflowerblue; font-weight: bold;">添加广告！</td>
    </table>
    <br>
    <form method="post" action="save_ad.php">
        广告名称:<input type="text" name="add_adname" id="add_adname" placeholder="请填写广告的名称"><br>
        广告图片:<input type="text" name="add_adpic" id="add_adpic" placeholder="请添加广告图片"><br>
        广告链接:<input type="text" name="add_adurl" id="add_adurl" placeholder="请添加广告链接"><br>
        广告价格:<input type="text" name="add_adprice" id="add_adprice" placeholder="请添加广告价格"><br>
        广告原价:<input type="text" name="add_adoprice" id="add_adoprice" placeholder="请添加广告原价"><br>
