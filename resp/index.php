...
<div id="container">
                ...
                <div class="span4">
                    <div id="myCarousel" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="active item"><img src="images/g1.png" alt=""  /></div>
                            <div class="item"><img src="images/g2.png" alt=""  /></div>
                            <div class="item"><img src="images/g3.png" alt=""  /></div>
                            <div class="item"><img src="images/g4.png" alt="" /></div>
                        </div>
    ...
    <div id="content">
        <div class="row">
            <?php
                include ("conn.php");
                $sql1=mysqli_query($link,"select * from tb_advertising ");
            ...
            <div class="text-center col-lg-3">
                <div class="box">
                    <a href="<?php echo $row1["alink"];?>"><img class="img-responsive" src="<?php echo $row1['apic'];?>"></a>
                    <li style="font-size: 16px;">商品名称:<a href="<?php echo $row1["alink"];?>"><?php echo $row1['aname'];?></a></li>
                    <li style="font-size: 16px;">商品价格:<?php echo $row1['aprice'];?>&nbsp;&nbsp;商品原价:<u style="text-decoration: line-through;color: #FF6100;"><?php echo $row1['aoprice'];?></u></li>
                </div>
            </div>
                    <?php
