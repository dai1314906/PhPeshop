...
<div id="container">
    ...
    <div id="container1">
        ...
        <br>
        <br>
        <table width="1200" bgcolor="#f5f5f5" height=" " border="0" align="center" cellpadding="1" cellspacing="0" >
            <tr>
                <td height="30" align="center" style="font-size: 20px;color: #FF6100;">选择购买</td>
                <td align="center" style="font-size: 20px;color: #FF6100;">商品图片</td>
                <td align="center" style="font-size: 20px;color: #FF6100;">商品详情</td>
                <td align="center" style="font-size: 20px;color: #FF6100;">商品价格</td>
                <td align="center" style="font-size: 20px;color: #FF6100;">购买数量</td>
                <td align="center" style="font-size: 20px;color: #FF6100;">商品总计</td>
                <td align="center" style="font-size: 20px;color: #FF6100;">移除收藏</td>
            </tr>
            <form action="buy.php" method="post" name="form1">
            <?php

            include ("conn.php");
            $uid = $_SESSION['id'];
            $sql = mysqli_query($link, "select * from tb_commodity join tb_cart on tb_cart.cid=tb_commodity.cid where uid='$uid'");
            ...
            do{
                ...
                <tr>
                    <td height="10" align="center" valign="top">
                        ...
                        <div align="center"><input type="checkbox" name="checkbox[]" id="cid" value="<?php echo $info['cid']?>"></div>
                    </td>
                    ...
                    <td height="10" align="center" valign="top">
                        <div align="center"><?php echo $info["cdetail"]?></div>
                    </td>
                    <td height="10" align="center" valign="top">
                        <div align="center"><?php echo $info["cprice"] ?></div>
                    </td>
                    <td height="10" align="center" valign="top">
                        <div align="center"><?php echo $info["canum"];?></div>
                    </td>

                    <td height="10" align="center" valign="top">
                        <div align="center"><?php echo $info["cprice"] * $info["canum"]?></div>
                    </td>


                    <td height="10" align="center" valign="top">
                        <div align="center"><a href="delete_cart.php?id=<?php echo $info["caid"];?>"><span class="glyphicon glyphicon-trash"></span></a></div>
                    </td>
