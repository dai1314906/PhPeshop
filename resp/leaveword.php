...
<div id="container">
    ...
    <div id="container1">
        <div style="text-align: center;padding-top: 250px;">
            <form method="post" action="save_leaveword.php" >
                请留言:<input type="text" name="add_title" id="add_title" placeholder="请填写留言信息">

                <input type="submit" name="Submit" value="发送">&nbsp;&nbsp;<input type="reset" name="Reset" value="重置">
